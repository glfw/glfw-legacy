...
% GLFW Users Guide
% API Version: 2.5
% $Id: glfwug.tex,v 1.11 2004-02-29 20:52:14 marcus256 Exp $
%-------------------------------------------------------------------------
...
will be generated and uploaded to texture memory. If \textit{flags} is
GLFW\_ALPHA\_MAP\_BIT, then any gray scale images will be loaded as alpha
maps rather than luminance maps.

...
GLFW\_OPENGL\_VERSION\_MAJOR & 1	        & Major number of the desired \OpenGL\ version.\\ \hline
GLFW\_OPENGL\_VERSION\_MINOR & 1	        & Minor number of the desired \OpenGL\ version.\\ \hline
...
\begin{refdescription}
This function selects which function to be called upon a window close
event.
...
\begin{refdescription}
This function selects which function to be called upon a window size
change event.
...
\begin{refdescription}
This function selects which function to be called upon a window refresh
...
\begin{refdescription}
This function selects which function to be called upon a mouse button
event.
...
\begin{refdescription}
This function selects which function to be called upon a mouse motion event.
...
\begin{refdescription}
This function selects which function to be called upon a mouse wheel event.

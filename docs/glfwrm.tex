...
% API Version: 2.5
% $Id: glfwrm.tex,v 1.14 2004-02-28 12:50:15 marcus256 Exp $
%-------------------------------------------------------------------------
...
Since \OpenGL~1.0 does not support single component alpha maps, gray scale
images are converted to RGBA format under \OpenGL~1.0 when the
GLFW\_ALPHA\_MAP\_BIT flag is set, where the red, green and blue components
are set to 255 (=1.0), and the alpha component is copied from the alpha
map.
\end{refnotes}

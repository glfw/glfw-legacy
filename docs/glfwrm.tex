...
specification but merely list some of the preconditions for certain parts of it
to function on a given machine.  As such, any part of it may change in future
versions without this being considered a breaking API change.

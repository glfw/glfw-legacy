...
default:
	...
	@echo "  $(MAKE) mingw-clean       to remove any files generated by MinGW"
	@echo "-----------------------------------------------------------------------------"
	@echo "  $(MAKE) win32-msys        to compile for Windows using MSYS"
	@echo "  $(MAKE) msys-clean        to remove any files generated by MSYS"
	...
	@echo "  $(MAKE) x11-clean         to remove any files generated for Unix and X11"
	...
	@echo "-----------------------------------------------------------------------------"
	@echo "  $(MAKE) cocoa             to compile GLFW for Cocoa on Mac OS X using GCC"
